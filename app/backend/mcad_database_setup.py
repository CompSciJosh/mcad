...
1st Issue - I was given the wrong directions for setting up an account. After I staged files internally,
created a database, and populated the database, my first account expired causing me to lose all my data.
2nd Issue - I was provided a link by Jonathan to setup the "correct" account. I populated Snowflake with the above
data again, created a backend that has a registration system linked to one of my Snowflake databases, linked multiple
new Python scripts to Snowflake. Now I am getting the error message:
"Warehouse 'MCAD_WAREHOUSE' cannot be resumed because resource monitor 'ACTMGT_RM_QEB91113' has exceeded its quota.".
3rd Issue - Also, this account does not allow me to change mt role from "Training_Role" so I can not collaborate with ny teammates.
Now Jonathan says he created another account for me and my teammates to use for collaboration which means I would have
to setup my files again.... No, thank you.
